...
class Program
{
    ...
    static string ConvertAlayToOriginal(string input)
    {
    ...
    static string FindBestMatch(string input, List<string> names, double similarityThreshold, out double highestSimilarity)
    {
